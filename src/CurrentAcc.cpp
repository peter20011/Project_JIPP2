...
void CurrentAcc::display_sp(int n)
{
    CurrentAcc ac;
    bool flag = false;
    ifstream inFile;
...
void CurrentAcc::modify_account(int n)
{
    bool found = false;
    CurrentAcc ac;
    fstream File;
...
void CurrentAcc::delete_account(int n)
{
    CurrentAcc ac;
    ifstream inFile;
    ofstream outFile;
...
void CurrentAcc::deposit_withdraw(int n , int option)
{
    int amt;
    bool found = false;
    CurrentAcc ac;
